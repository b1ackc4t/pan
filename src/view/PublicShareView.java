...
public class PublicShareView extends HttpServlet {
	...
	public void doGet(HttpServletRequest req, HttpServletResponse res)
		...
		out.print("<!DOCTYPE HTML PUBLIC \"-//W3C//DTD HTML 4.01 Transitional//EN\">\r\n" + 
				...
				"									上传资源\r\n" + 
				"								</button>\r\n" + 
				"								<form style=\"display: none;\" id=\"form1\" action=\"./PublicShare?dir="+URLEncoder.encode(dir, "UTF-8")+"&method=upload\" method=\"post\" enctype=\"multipart/form-data\" >\r\n" + 
		...
		out.print("<a href=\"./PublicShare?dir=\">公共资源</a>>>	\r\n");
		
		String m = sepp;
		for (String str : Arrays.asList(dir.split(sep))) {
			if (!str.trim().equals("")) {
				m += str+sepp;
				out.print("<a href=\"./PublicShare?dir="+URLEncoder.encode(m, "UTF-8")+"\">"+str+"</a>>>	\r\n");
			}
		} 
		...
		if (!(filetotal.isEmpty() && dirtotal.isEmpty())) {
			for (ArrayList dli : dirtotal) {
				out.print("<tr>\r\n" + 
						...
						"									<td><a href=\"./PublicShare?dir="+URLEncoder.encode(dir+dli.get(0)+sepp, "UTF-8")+"\">"+dli.get(0)+"</a></td>\r\n" + 
						"									<td>-</td>\r\n" + 
						"									<td>"+dli.get(1)+"</td>\r\n" + 
						"									<td>"+dli.get(2)+"</td>\r\n" + 
						"									<td>"+dli.get(3)+"</td>\r\n" + 
			...
			for (ArrayList fli : filetotal) {
				out.print("<tr>\r\n" + 
						...
						"									<td>"+fli.get(3)+"</td>\r\n" + 
						"									<td>"+fli.get(4)+"</td>\r\n" + 
						"									<td><a href=\"./DownloadFile?target=public&dir="+URLEncoder.encode(dir, "UTF-8")+"&name="+fli.get(0)+"\">下载</a></td>\r\n" + 
						"									<!-- 点击下载 -->\r\n" + 
						"								</tr>");
