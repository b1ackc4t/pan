...
public class FindAnyView extends HttpServlet {
			...
			for (ArrayList fli : filetotal) {
				...
				if (fli.get(4).equals("DIR")) {
					...
					out.print("<tr>\r\n" + 
							...
							"									<td><a href=\"./UserFile?username="+name+"&dir="+URLEncoder.encode((String)fli.get(1)+fli.get(0)+sepp, "UTF-8")+"\">"+fli.get(0)+"</a></td>\r\n" + 
							"									<td>"+fli.get(1)+"</td>\r\n" + 
							"									<td>"+si+"</td>\r\n" + 
							"									<td>"+fli.get(3)+"</td>\r\n" + 
							"									<td>"+fli.get(4)+"</td>\r\n" + 
							"									<td><a href=\"./UserFile?username="+name+"&dir="+URLEncoder.encode((String)fli.get(1), "UTF-8")+"&method=delete&name="+fli.get(0)+"\">删除</a></td>\r\n" + 
					...
					out.print("<tr>\r\n" + 
							...
							"									<td><a href=\"./UserFile?username="+name+"&dir="+URLEncoder.encode((String)fli.get(1), "UTF-8")+"\">"+fli.get(0)+"</td>\r\n" + 
							"									<td>"+fli.get(1)+"</td>\r\n" + 
							"									<td>"+si+"</td>\r\n" + 
							"									<td>"+fli.get(3)+"</td>\r\n" + 
							"									<td>"+fli.get(4)+"</td>\r\n" + 
							"									<td><a href=\"./UserFile?username="+name+"&dir="+URLEncoder.encode((String)fli.get(1), "UTF-8" )+"&method=delete&name="+fli.get(0)+"\">删除</a><a href=\"./UserFile?username="+name+"&dir="+URLEncoder.encode((String)fli.get(1), "UTF-8")+"&method=share&name="+fli.get(0)+"\">分享</a> <a href=\"./DownloadFile?target=home&dir="+URLEncoder.encode((String)fli.get(1), "UTF-8")+"&name="+fli.get(0)+"\">下载</a></td>\r\n" + 
							"									<!-- 点击下载 -->\r\n" + 
							"								</tr>");
				}
